...
def nn_forward_backward(
    ...
    dh1 = dscores @ W2.T
    dh1[h1 <= 0] = 0  # Backprop through ReLU
...
def nn_get_search_params():
    ...
    regularization_strengths = [1e-3, 5e-3, 1e-4]
            ...
            for reg in regularization_strengths:
                for decay in learning_rate_decays:
                    ...
                    if val_acc > best_val_acc:
                        ...
                        print(f"✅ New best found! val_acc={val_acc:.4f} | lr={lr} hs={hs} reg={reg} decay={decay}")
